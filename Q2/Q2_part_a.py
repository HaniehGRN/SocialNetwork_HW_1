...
def get_nodes_in_out_degree(G, N):
...
def Q2_part_b(b, x_start, x_end, r_start, r_end, sample_size):
    ...
    graph_density_3D_surface_plot([pair[0] for pair in x_r_pair_list] , [pair[1] for pair in x_r_pair_list], graph_density_list)
    theoretical_simulated_density_oneplot([pair[1] for pair in x_r_pair_list], graph_density_list,get_theoretical_density([pair[0] for pair in x_r_pair_list], [pair[1] for pair in x_r_pair_list], b))
